...
use CV\CascadeClassifier as CascadeClassifierAlias, CV\Scalar;
use function CV\{imread, imwrite, cvtColor, equalizeHist, rectangleByRect};
use const CV\{COLOR_BGR2GRAY};


$src = imread("detected/images/face.jpg");
...
imwrite("detected/results/_detect_face_by_cascade_classifier.jpg", $src);